...
public class CartItemModel {
  ...
  private int coupensApplied;
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupens, String productPrice, String productCuttedPrice, int productQuantity, int offersApplied, int coupensApplied) {
        this.type = type;
